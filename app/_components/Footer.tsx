      ...
      <div className="max-w-7xl mx-auto py-12 px-4 sm:px-6 lg:px-8">
        <div className="md:flex md:items-center md:justify-between">
          <div className="flex justify-center space-x-6 md:order-2">
            ...
            <Link href="#" className="text-[#6b7280] hover:text-[#1f2937]">
          ...
          <div className="mt-8 md:mt-0 md:order-1 flex items-center justify-center">
            {SYNERGY_LOGO_SVG}
            <p className="ml-3 text-center text-base text-[#6b7280]">
              &copy; {new Date().getFullYear()} SynergyKit. All rights reserved.
            </p>
          </div>
        </div>
      </div>
